...
import 'package:swift_ride/app/modules/ride/widgets/upcoming_trip_widgets.dart';
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => MapScreen(lat: widget.lat, lng: widget.lng),
                    ),
                  );
                },
                child: ClipRRect(
